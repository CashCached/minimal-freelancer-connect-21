...
const PricingPlans = () => {
  return (
    <section className="py-24 px-4 relative overflow-hidden">
      <div className="absolute top-0 left-0 w-full h-full bg-gradient-radial from-brand-pink/10 via-transparent to-transparent opacity-30"></div>
      ...
      <div className="container mx-auto max-w-6xl relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Individual Plan */}
          <div className="glass-card p-8 hover-lift transition-all duration-300 hover:border-brand-pink/30 relative overflow-hidden group">
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-brand-pink/5 blur-3xl group-hover:bg-brand-pink/10 transition-all duration-500"></div>
            
            <div className="relative z-10">
              <div className="w-12 h-12 rounded-xl bg-gradient-to-br from-brand-pink to-brand-purpleDark flex items-center justify-center mb-6">
              ...
              <ul className="space-y-3 mb-8">
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-pink mt-0.5" />
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-pink mt-0.5" />
                  <span className="text-white/80">₹5,00,000 monthly payment volume</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-pink mt-0.5" />
              ...
              <Button className="w-full bg-white/10 hover:bg-brand-pink/20 text-white border border-white/10">
                Start Free Trial
              </Button>
            </div>
          </div>
          ...
          <div className="glass-card p-8 scale-105 hover-lift transition-all duration-300 border-brand-pink/20 shadow-lg relative overflow-visible group mt-6">
            ...
            <div className="absolute -top-20 -right-20 w-64 h-64 rounded-full bg-brand-pink/10 blur-3xl group-hover:bg-brand-pink/20 transition-all duration-500"></div>
            ...
            <div className="relative z-10">
              ...
              <ul className="space-y-3 mb-8">
                ...
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-pink mt-0.5" />
                  <span className="text-white/80">₹25,00,000 monthly payment volume</span>
                </li>
                <li className="flex items-start gap-2">
                  <Check className="w-5 h-5 text-brand-pink mt-0.5" />
              ...
              <Button className="w-full bg-brand-pink hover:bg-brand-purpleDark text-white">
                Start Free Trial
              </Button>
            </div>
          </div>
