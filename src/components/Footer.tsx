...
const Footer = () => {
  ...
  return (
    <footer className="bg-brand-green py-12 mt-16 relative overflow-hidden text-brand-cream">
        ...
        <div className="p-8 rounded-2xl backdrop-blur-sm bg-brand-darkGreen/10 border border-brand-cream/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-8">
            ...
            <div className="grid grid-cols-2 gap-x-12 gap-y-4">
              ...
              <div className="flex flex-col items-center md:items-start">
                ...
                <span className="text-brand-cream/80">contact@schedulepro.com</span>
          ...
          <div className="mt-8 pt-8 border-t border-brand-cream/10 flex flex-col md:flex-row justify-between items-center">
            ...
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-gold to-brand-cream flex items-center justify-center text-brand-darkGreen">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
                  <path d="M16 8.049c0-4.446-3.582-8.05-8-8.05C3.58 0-.002 3.603-.002 8.05c0 4.017 2.926 7.347 6.75 7.951v-5.625h-2.03V8.05H6.75V6.275c0-2.017 1.195-3.131 3.022-3.131.876 0 1.791.157 1.791.157v1.98h-1.009c-.993 0-1.303.621-1.303 1.258v1.51h2.218l-.354 2.326H9.25V16c3.824-.604 6.75-3.934 6.75-7.951z"/>
                </svg>
              </a>
              <a href="#" className="w-8 h-8 rounded-full bg-gradient-to-br from-brand-cream to-brand-gold flex items-center justify-center text-brand-darkGreen">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
