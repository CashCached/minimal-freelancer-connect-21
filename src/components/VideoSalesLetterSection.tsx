  ...
  return (
    <section className="py-16 md:py-24 px-6 md:px-12 lg:px-24 bg-gradient-to-b from-white to-brand-cream/20 relative overflow-hidden">
      ...
      <div className="container mx-auto max-w-4xl text-center">
        ...
        <div className="relative max-w-2xl mx-auto rounded-2xl overflow-hidden shadow-2xl border border-brand-cream/30 mb-12">
        ...
        {/* Testimonial card */}
        <Card className="mb-8 bg-white/80 backdrop-blur-sm border border-brand-cream/30 shadow-md max-w-2xl mx-auto">
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                <p className="text-brand-darkGreen/90 italic mb-3 text-left">
